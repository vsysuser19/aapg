...
def test_branch(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[1]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[1])])
    try:
...
def test_csr(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[2]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[2])])
    try:
...
def test_switch_mode(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[3]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[3])])
    try:
...
def test_exceptions(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[4]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[4])])
    try:
...
def test_i_cache(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[5]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[5])])
    try:
...
def test_recursion(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[6]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[6])])
    try:
...
def test_all(runner):
    ...
    result = runner.invoke(cli, ['gen','--setup_dir=tests/work/{config_file}'.format(config_file=list_of_files[7]),'--output_dir=tests/work/{config_file}/asm'.format(config_file=list_of_files[7])])
    try:
